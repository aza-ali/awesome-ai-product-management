# Awesome AI Product Management [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> Curated tools, frameworks, writing, and resources for product managers building in the AI era.

The job of "PM" is being rewritten in real time. This list is for PMs who want to ship faster with AI tools, think clearly about AI product strategy, and stay current on the frameworks and writing shaping the practice.
...
Newsletters and blogs that consistently move the needle on AI product thinking.

- [Lenny's Newsletter](https://www.lennysnewsletter.com/) - Weekly essays on product, growth, and AI from a former Airbnb PM.
- [Stratechery by Ben Thompson](https://stratechery.com/) - Strategic analysis of tech and product, with deep AI coverage.
- [The Pragmatic Engineer](https://newsletter.pragmaticengineer.com/) - Engineering-side reading every PM-who-codes should follow.
- [Latent Space](https://www.latent.space/) - The AI engineer's newsletter and podcast.
- [Last Week in AI](https://lastweekin.ai/) - Curated AI news digest.
- [Import AI by Jack Clark](https://importai.substack.com/) - Weekly AI research and policy newsletter from a co-founder of Anthropic.
...
A starting set — accounts that consistently post substantive PM/AI content. Open a PR to add others.

- [Lenny Rachitsky](https://twitter.com/lennysan) - Lenny's Newsletter author. Product, growth, AI.
...
Contributions welcome. Open a PR to add a resource. Guidelines:

- One resource per PR.
- Place additions alphabetically within the relevant section.
- Use the format: `[Name](URL) - Short description ending with a period.`
- Description should be 1-2 sentences, descriptive, not marketing.
- Resource must be substantive — no thin link-collections, no paid-only content without significant free portion, no general productivity tools without clear PM/AI angle.
...
To the extent possible under law, [Aza Ali](https://github.com/aza-ali) has waived all copyright and related or neighboring rights to this work.
